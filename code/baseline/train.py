...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_dir', type=str, default=str(PROJECT_ROOT / "Train_Set_clean_augmented"))
    parser.add_argument('--output_dir', type=str, default=str(PROJECT_ROOT / "cpa_output_clean_aug"))
